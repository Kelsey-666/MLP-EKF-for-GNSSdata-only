...
import numpy as np
from gnss_foundation.gnss_type import uGNSS, uTYP, rSigRnx
from gnss_foundation.gnss_type import bdt2gpst, time2bdt
from gnss_foundation.gnss_type import gpst2time, bdt2time, epoch2time, timediff, gtime_t
from gnss_foundation.gnss_type import prn2sat, char2sys, timeget, utc2gpst, time2epoch
from gnss_foundation.gnss_type import Eph, Geph, Obs, sat2id, sat2prn, gpst2bdt, time2gpst
from gnss_foundation.gnss_type import timeadd, id2sat, gpst2utc
    ...
    def decode_obs(self):
        ...
        for line in self.fobs:
            ...
            for _ in range(nsat):
                ...
                dp = np.zeros(len(self.getSignals(sys, uTYP.D)), dtype=np.float64)
